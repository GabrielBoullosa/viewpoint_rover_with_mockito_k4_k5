...
public class Rover__ {
    ...
    public void could_turn_left() {
        ...
        assertThat(((SimpleViewPoint)rover.viewPoint()).position()).isEqualTo(new Position(3,3));
    }
    ...
    public void could_turn_right() {
        ...
        assertThat(((SimpleViewPoint)rover.viewPoint()).position()).isEqualTo(new Position(5,1));
    }
    ...
    public void could_go_forward() {
        ...
        rover.go(Forward);
        assertThat(((SimpleViewPoint)rover.viewPoint()).heading()).isEqualTo(South);
        assertThat(((SimpleViewPoint)rover.viewPoint()).position()).isEqualTo(new Position(-1,0));
    }
    ...
    public void could_go_backward() {
        ...
        rover.go(Backward);
        assertThat(((SimpleViewPoint)rover.viewPoint()).heading()).isEqualTo(West);
        assertThat(((SimpleViewPoint)rover.viewPoint()).position()).isEqualTo(new Position(-3,4));
    }
    ...
    public void could_execute_many_orders() {
        ...
        assertThat(((SimpleViewPoint)rover.viewPoint()).heading()).isEqualTo(West);
        assertThat(((SimpleViewPoint)rover.viewPoint()).position()).isEqualTo(new Position(3,0));
    }
